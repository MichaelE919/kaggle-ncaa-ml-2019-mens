...
for year in range(2003, 2020):
    ...
    try:
        ...
        pass
    try:
        swap('Charleston', 'Col Charleston')
    except ValueError:
        pass
...
kp_2019 = pd.read_csv('KenPom_2019.csv')
...
kp_2019.insert(0, column='Season', value=2019)
